...
``ANETHACKOPTIONS'' environment variable or in a configuration file.
...
%.pg
The ANETHACKOPTIONS variable is a comma-separated list of initial
...
%.sd
\begin{verbatim}
    setenv ANETHACKOPTIONS "autoquiver,\!autopickup,name:Blue Meanie,fruit:papaya"
\end{verbatim}
%.ed
...
%.sd
\begin{verbatim}
    ANETHACKOPTIONS="autoquiver,!autopickup,name:Blue Meanie,fruit:papaya"
    export ANETHACKOPTIONS
\end{verbatim}
%.ed
...
filled out with options in the same syntax as in ANETHACKOPTIONS.
...
operating systems, but ANETHACKOPTIONS can also be set to
